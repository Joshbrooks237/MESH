...
class VolunteerClient:
    ...
    async def _process_genetic_analysis(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.warning(f"AI models not available ({e}), using mock analysis")
            result = {
                'variants_analyzed': len(variants),
        ...
        # Simulate processing time based on variant count
        await asyncio.sleep(min(len(variants) * 0.05, 5.0))  # Max 5 seconds
    ...
    async def _process_drug_screening(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Simulate processing time based on compound count
        await asyncio.sleep(min(len(compounds) * 0.01, 3.0))  # Max 3 seconds
        return result
    ...
    async def _process_image_analysis(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Simulate processing time based on image count
        await asyncio.sleep(min(len(images) * 0.2, 10.0))  # Max 10 seconds
